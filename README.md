...
This repository is provided for students looking to work on a simple access panel web application as a practice project.

View the code [using GitHub Preview](https://html-preview.github.io/?url=https://raw.githubusercontent.com/pecknigel/access-panel-practice-project/refs/heads/main/index.html).
...
![Example Image](https://github.com/user-attachments/assets/8aed88a9-686a-432a-9d5e-951108ba5e73)
...
To learn what you need to complete this project, check out the [Courses and Resources](https://library.peckn.net/resources) page.

Ongoing support and guided learning is available from Nigel via [Preply](https://preply.com/en/tutor/4217857).

## Tasks

For ideas on how to move forward with using this project to practice writing software, see [TASKS](https://github.com/pecknigel/access-panel-practice-project/blob/main/TASKS.md).
